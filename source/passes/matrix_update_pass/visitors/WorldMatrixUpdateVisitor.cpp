...
WorldMatrixUpdateVisitor::WorldMatrixUpdateVisitor(glm::mat4 worldMatrix, glm::quat worldRotation)
...
void WorldMatrixUpdateVisitor::visit(CameraNode& cameraNode) {
    ...
    WorldMatrixUpdateVisitor(_worldMatrix * cameraNode.matrix(), _worldRotation * cameraNode.rotation())
        .traverse(cameraNode);
}
...
void WorldMatrixUpdateVisitor::visit(SpatialNode& spatialNode) {
    ...
    WorldMatrixUpdateVisitor(_worldMatrix * spatialNode.matrix(), _worldRotation * spatialNode.rotation())
...
void WorldMatrixUpdateVisitor::visit(GeometryNode& geometryNode) {
    ...
    WorldMatrixUpdateVisitor(_worldMatrix * geometryNode.matrix(), _worldRotation * geometryNode.rotation())
...
void WorldMatrixUpdateVisitor::visit(PointLightNode& pointLightNode) {
    ...
    WorldMatrixUpdateVisitor(_worldMatrix * pointLightNode.matrix(), _worldRotation * pointLightNode.rotation())
